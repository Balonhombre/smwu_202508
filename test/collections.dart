class Collections{
  ...
  void mapController() {
    ...
    var maValue = m["a"];
    print('Collections.mapController m : $maValue');
    m["d"] = 40;
    m.remove("c");
    ...
    print('Collections.mapController : ');
  }
  ...
  void practice() {
    ...
    print('Collections.practice map2 : $ageMap');
